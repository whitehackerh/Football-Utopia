...
class GetFilterSettingsService extends BaseService {
    ...
    private function formatResponseData($record) {
        ...
        if ($record->count()) {
            ...
            $data['age']['min'] = $record[0]->min_age;
            $data['age']['max'] = $record[0]->max_age;
            $data['gender']['id'] = $record[0]->gender_id;
            $data['gender']['name'] = $record[0]->gender_name;
            $data['nationality']['id'] = $record[0]->nation_id;
            $data['nationality']['name'] = $record[0]->nation_name;
