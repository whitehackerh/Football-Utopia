...
class SetProfilePictureService extends BaseService {
    public function service(Request $request) {
        try {
            ...
            $profilePicutreCroppedName = 'profilePictureCropped' . $profilePictureNo . '.png';
            ...
            Storage::putFileAs($profilePictureDirectory, $request->file('croppedPicture'), $profilePicutreCroppedName);
            ...
            $model->updateProfilePicture($user_id, $profilePictureCroppedColumn, $profilePictureOriginalColumn, $profilePictureDirectory . '/' . $profilePicutreCroppedName, $profilePictureDirectory . '/' . $profilePictureOriginalName);
            return null;
        } catch (Exception $e) {
